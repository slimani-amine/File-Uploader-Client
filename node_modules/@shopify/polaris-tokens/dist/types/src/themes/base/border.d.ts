...
export type BorderRadiusScale = '0' | '050' | '100' | '150' | '200' | '300' | '400' | '500' | '750' | 'full' | '05' | '1' | '2' | '3' | '4' | '5' | '6' | BorderRadiusScaleExperimental;
type BorderWidthScaleExperimental = Experimental<'1' | '2'>;
export type BorderWidthScale = '0165' | '025' | '050' | '100' | '1' | '2' | '3' | '4' | '5' | BorderWidthScaleExperimental;
